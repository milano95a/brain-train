...
return pos;},getPositionRecursively:function(el){var pos={top:0,left:0};var orig_el=el;while(el){if(getComputedStyle(el)["position"]=="fixed"){return orig_el.getBoundingClientRect();}
